...
def load_scene():
    ...
    surface = diffuse_plate_class.DiffusePlateClass(p0=np.array([0,0]), n0=np.array([-1,0]), length=20 * mm, thickness=1 * mm, Kd=1, Ks=2, alpha=100, nr_of_scattered_rays=1000, n_light=-light.n0)
