...
def load_scene():
    ...
    lens1 = spherical_lens_class.SphericalLensClass(p0=np.array([0,          0]), n0=np.array([-1,0]), R0=  62.63*mm, R1=-348.5*mm, thickness=t1, diameter=60, N=1.745)
    lens2 = spherical_lens_class.SphericalLensClass(p0=np.array([t1+s1,      0]), n0=np.array([-1,0]), R0= -66.47*mm, R1= 39.62*mm, thickness=t2, diameter=50, N=1.647)
    lens3 = spherical_lens_class.SphericalLensClass(p0=np.array([t1+s1+t2+s2,0]), n0=np.array([-1,0]), R0= 119.50*mm, R1=-52.41*mm, thickness=t3, diameter=50, N=1.697)
